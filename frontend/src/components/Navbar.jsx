...
const Navbar = () => {
  ...
  return (
    <div className="w-full sticky top-0 bg-slate-200 flex py-6 items-center justify-around">
      ...
      >
        {/* image of logo */}
        <div className="h-10 border-[1px] border-slate-400 w-10 rounded-full ">
          <img
            src="https://www.pngmart.com/files/21/Hospital-PNG-HD.png"
            alt="logo"
          />
        </div>
        kareAI
      ...
      <div className="flex gap-6 items-center">
        ...
        <NavLink
          to={"/"}
          className={({ isActive }) =>
            `text-md tracking-wider hover:text-blue-500 font-medium ${
        ...
        {user && (
          ...
          >
            <img
              src="https://cdn4.iconfinder.com/data/icons/professions-2-2/151/73-256.png"
              alt="profile"
            />
          </Link>
        )}
